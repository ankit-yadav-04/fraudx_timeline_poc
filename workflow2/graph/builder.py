...
from workflow2.nodes.step2_5 import step2_5_screen_chunks_node
...
class FraudTimelineWorkflow2Builder:
    ...
    async def build(self):
        ...
        builder.add_node("step2_5_screen_chunks", step2_5_screen_chunks_node)
        ...
        builder.add_edge("step2_extract_dates", "step2_5_screen_chunks")
        builder.add_edge("step2_5_screen_chunks", "step3_combine_by_date")
