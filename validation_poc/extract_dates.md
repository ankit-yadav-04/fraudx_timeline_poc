...
8. **For every event, note its source context** — identify whether the chunk originates from 
   a treating physician note, IME report, radiology report, legal/attorney document, 
   discharge summary, or other source. Include this in the event_summary. This is critical 
...
- **Source context** (what type of document this chunk appears to come from — e.g., radiology 
  report, IME report, treating physician note, legal deposition)
- **Patient name** as stated in the chunk (if present)
- **Facility or clinic name** if mentioned near the event
...
|------------|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| MRI result | "MRI was done"             | "Per radiology report, MRI of the cervical spine without contrast performed for Erik Barrezueta, revealing straightening of cervical lordosis and broad-based central disc herniation at C5-6 compressing the ventral CSF space. Study ordered by Dr. Hayes at Northside Imaging Center in context of work-related neck pain claim." |
| Medication | "Patient given medication" | "Per treating physician note from Dr. Patel at City Spine Clinic, oral Amoxicillin 500mg prescribed three times daily for 7 days to Erik Barrezueta for confirmed bacterial pneumonia following post-operative complication. This is a direct treatment event, not a cited reference." |
| Surgery    | "Surgery performed"        | "Per operative report from St. Mary's Hospital, arthroscopic ACL reconstruction of the left knee performed on the patient by Dr. Smith under general anaesthesia; no intraoperative complications reported. Document is a first-hand surgical record, not a referenced or cited case." |
| IME report | "Doctor evaluated patient" | "Per Independent Medical Examination (IME) report authored by Dr. Collins, patient Erik Barrezueta evaluated for right shoulder rotator cuff tear claimed as work-related injury. Dr. Collins concludes the tear is degenerative in nature and pre-existing, contradicting the treating physician's findings." |
| Cited case | "Prior injury mentioned"   | "Attorney letter references a 1998 slip-and-fall case involving a different claimant as legal precedent. This event does not relate to the current patient's medical history and should be treated as a cited reference, not a direct patient event." |
